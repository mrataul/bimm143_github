...
Seems like This downregulated the cell cycle, DNA replication, and RNA
transport
...
![](hsa04330.pathview.png) ![](hsa04142.pathview.png)
...
![](Screenshot%202026-05-14%20125354.png) \> Q: What pathway has the
...
2.63E-5. The top results seem to match since cell cycle and mitosis
related phenomenon are high up on the list for reactome analysis as well
as on the KEGG. The main difference is that there seems to be more
detail in the KEGG analysis whereas the reactome analysis looks very
general and has a lot of different areas it looks into.
